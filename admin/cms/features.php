...
<?php
  $id = 5; // Features
  $sqlQuery = "SELECT id, name, title, sub_title, objective, mission, description, cms_image FROM cms where id = $id";
            ...
            <div class="col">
              ...
              <div class="form-group row col-md-12">
                <div class="col-md-12">
                  ...
                  <textarea class="form-control" name="objective"><?php echo $row['objective']; ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group row col-md-12">
                <div class="col-md-12">
                  ...
                  <textarea class="form-control" name="mission"><?php echo $row['mission']; ?></textarea>
                </div>
              </div>
