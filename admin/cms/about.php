...
<?php
  $id = 1; // About
  $sqlQuery = "SELECT id, name, title, sub_title, home_about_description, description, cms_image FROM cms where id = $id";
        ...
        <div class="card-body">
          <div class="row mt-4">
            <div class="col">
              ...
              <div class="form-group row col-md-12">
                <div class="col-md-12">
                  <label class="col-form-label">Home Page Description</label>
                  <textarea class="form-control" name="home_about_description"><?php echo $row['home_about_description']; ?></textarea>
                </div>
              </div>
