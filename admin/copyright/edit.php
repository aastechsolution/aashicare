  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Copyright Details</h1>
          </div>
          <div class="col-sm-6">
...
<?php
  $sqlQuery = "SELECT id, company_name, copyright_year FROM copyright where status = 'Active'";
            ...
            <div class="col">
              <div class="form-group row col-md-12">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="copyright_year" value="<?php echo $row['copyright_year']; ?>">
                </div>
              </div>
